...
// ----------------------------------------------------------------------------
/**
 * Manages a collection of elements, each with an associated probability of
 * selection weights and allows their random selection.
 *
...
public class WeightedSelection<E> {
    ...
    public E choose() {
        ...
        // returns [0.0,1.0). But floorEntry() makes it much harder to
        // extract weights and thresholds from the entries.
    ...
    /**
     * Sorted map to the elements with the key being the running total of an
     * element's weight and the weights of all elements added before it.
     */
